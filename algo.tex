...
Algorithm~\ref{algo:mergesort} is a recursive algorithm to sort an input array. It uses the Algorithm~\ref{algo:merge} as a subroutine. Refer to \cite{atharvaveda} for more details. 
